...
TODO: {
  ...
  $returnCode = $objectPlugins->browseragent () eq 'Mozilla/5.0 (compatible; ASNMTAP; U; ASNMTAP 3.001.003 postfix; nl-BE; rv:3.001.003) rv:3.001.003) Gecko/20100310 libwww-perl/5.813 libwww-perl/5.813' ? 1 : 0;
  ...
  $returnCode = $objectPlugins->programVersion () eq '3.001.003' ? 1 : 0;
