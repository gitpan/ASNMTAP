...
TODO: {
  ...
  $returnCode = $objectPlugins->browseragent () eq 'Mozilla/5.0 (compatible; ASNMTAP; U; ASNMTAP 3.002.001 postfix; nl-BE; rv:3.002.001) Gecko/yyyymmdd libwww-perl/5.813' ? 1 : 0;
  ...
  $returnCode = $objectPlugins->programVersion () eq '3.002.001' ? 1 : 0;
