...
TODO: {
  ...
  $returnCode = $objectPlugins->browseragent () eq 'Mozilla/5.0 (compatible; ASNMTAP; U; ASNMTAP 3.000.015 postfix; nl-BE; rv:3.000.015) Gecko/20071021 libwww-perl/5.805' ? 1 : 0;
  ...
  $returnCode = $objectPlugins->programVersion () eq '3.000.015' ? 1 : 0;
