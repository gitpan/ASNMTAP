...
TODO: {
  ...
  $returnCode = $objectPlugins->browseragent () eq 'Mozilla/5.0 (compatible; ASNMTAP; U; ASNMTAP 3.000.018 postfix; nl-BE; rv:3.000.018) Gecko/20080609 libwww-perl/5.813' ? 1 : 0;
  ...
  $returnCode = $objectPlugins->programVersion () eq '3.000.018' ? 1 : 0;
