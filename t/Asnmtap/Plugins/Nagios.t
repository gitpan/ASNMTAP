...
TODO: {
  ...
  $returnCode = $objectNagios->browseragent () eq 'Mozilla/5.0 (compatible; ASNMTAP; U; ASNMTAP 3.001.001 postfix; nl-BE; rv:3.001.001) Gecko/yyyymmdd libwww-perl/5.813' ? 1 : 0;
  ...
  $returnCode = $objectNagios->programVersion () eq '3.001.001' ? 1 : 0;
