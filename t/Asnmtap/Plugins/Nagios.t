...
TODO: {
  ...
  $returnCode = $objectNagios->browseragent () eq 'Mozilla/5.0 (compatible; MSIE 6.0; ASNMTAP; U; ASNMTAP-3.000.007 postfix; nl-BE; rv:3.000.007) Gecko/20060115 libwww-perl/5.803' ? 1 : 0;
  ...
  $returnCode = $objectNagios->programVersion () eq '3.000.007' ? 1 : 0;
