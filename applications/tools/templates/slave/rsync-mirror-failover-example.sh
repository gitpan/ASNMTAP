...
#
# authorized_keys -> command='/opt/asnmtap-3.000.xxx/applications/master/rsync-wrapper-failover-02.sh' ...
#                 -> command='/opt/asnmtap-3.000.xxx/applications/master/rsync-wrapper-failover-05.sh' ...
#                 -> command='/opt/asnmtap-3.000.xxx/applications/master/rsync-wrapper-failover-10.sh' ...
#                 -> command='/opt/asnmtap-3.000.xxx/applications/master/rsync-wrapper-failover-15.sh' ...
# ------------------------------------------------------------------------------
# vi hosts.allow
