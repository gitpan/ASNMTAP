...
# ----------------------------------------------------------------------------------------------------------
# 2008/mm/dd, v3.000.017, collector.pl for ASNMTAP::Asnmtap::Applications::Collector
# ----------------------------------------------------------------------------------------------------------
...
use ASNMTAP::Asnmtap::Applications::Collector v3.000.017;
...
sub call_system {
  ...
  if ($dumphttp ne 'N') {
    $httpdumpFilename = $httpdump . get_datetime() .'-'. $msgCommand .'-'. $uniqueKey;
