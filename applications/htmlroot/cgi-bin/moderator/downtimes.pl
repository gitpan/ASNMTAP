...
# ---------------------------------------------------------------------------------------------------------
# 2009/mm/dd, v3.001.000, downtimes.pl for ASNMTAP::Asnmtap::Applications::CGI
# ---------------------------------------------------------------------------------------------------------
...
HTML
    ...
    <tr align="center"><td colspan="2">
	  <table border="0" cellspacing="0" cellpadding="0"><tr>
        <td class="StatusItem"><a href="$urlWithAccessParameters&amp;action=insertView">[Insert new downtimes]</a></td>
...
HTML
      ...
      if ($action eq 'insertView') {
        my $instabilityDisabled = ($userType < 4) ? 'disabled' : '';
