...
=head1 SYNOPSIS
  ...
  my $hihi = $objectAsnmtap->getOptionsArgv ('hihi');
  print "getOptionsArgv : hihi   = $hihi\n" if (defined $hihi);
...
Is a Perl module that provides IO functions used by ASNMTAP and ASNMTAP-based applications and plugins.
...
default 'NOT DEFINED'
scalar, the program name

=item _programDescription

default 'NOT DEFINED'
scalar, the program description

=item _programVersion

default '0.000.000'
scalar, the program version

=item _programUsagePrefix

default undef
scalar, the program usage prefix

=item _programHelpPrefix

default undef
scalar, the program help prefix
...
returned the get option argv value or undef when item don't exists
  
=item Example

my $objectAsnmtap = ASNMTAP::Asnmtap->new (
  ...
  _programUsagePrefix => '[--dumpData] [--hihi]',
  _programHelpPrefix  => "--dumpData ...
--hihi ...",
  _programGetOptions => ['dumpData', 'hihi=s'],
  ...
); 
...
returned the get option value or undef when item don't exists
...
ASNMTAP::Asnmtap::Plugins::Mail, ASNMTAP::Asnmtap::Plugins::Modem, ASNMTAP::Asnmtap::Plugins::SOAP, ASNMTAP::Asnmtap::Plugins::WebTransact, ASNMTAP::Asnmtap::Plugins::XML
