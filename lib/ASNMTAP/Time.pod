...
=head1 SYNOPSIS
  ...
  print "epoch 1 days ago  : ", get_epoch ('1 days ago'), "\n";
  print "week  1 week ago  : ", get_week ('1 week ago'), "\n";
  print "wday  1 days ago  : ", get_wday ('1 days ago'), "\n";
  print "day   1 days ago  : ", get_day ('1 days ago'), "\n";
  print "month 1 month ago : ", get_month ('1 month ago'), "\n";
  print "year  1 year ago  : ", get_year ('1 year ago'), "\n";
...
Returns the epoch time described by $STRING, not `now'.

=item *

get_week()

Returns the week and year described by $STRING, not `now', where week (01-53) started on a Monday, calculated for the current localtime() or specified time() at call.

=item *

get_wday()

Returns the day of week described by $STRING, not `now', where day of week (1-7) first day of week is Monday, calculated for the current localtime() or specified time() at call.
...
Returns the day of month described by $STRING, not `now', where day of month (01-31), calculated for the current localtime() or specified time() at call.

=item *

get_month()

Returns the month described by $STRING, not `now', where month (01-12), calculated for the current localtime() or specified time() at call.

=item *

get_year()

Returns the year described by $STRING, not `now', where year (YYYY), calculated for the current localtime() or specified time() at call.
