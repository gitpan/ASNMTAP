...
scalar, default 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; ASNMTAP; U; ASNMTAP-3.000.010 postfix; nl-BE; rv:3.000.010) Gecko/200607xx libwww-perl/5.805'
...
1 = with Performance Data for 'Status'

2 = with Performance Data for 'Compilation', 'Duration/Trendline' and 'Execution'

3 = with Performance Data for 'Status', 'Compilation', 'Duration/Trendline' and 'Execution'

4 = normal exit,

5 = with Performance Data for 'Status'

6 = with Performance Data for 'Compilation', 'Duration/Trendline' and 'Execution'

7 = with Performance Data for 'Status', 'Compilation', 'Duration/Trendline' and 'Execution'
